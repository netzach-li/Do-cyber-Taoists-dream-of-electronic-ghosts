...
local function addcanopyrow(widget,row)
    ...
    for i=1,#POS_INDEX do
        ...
        new_widget_AnimState:SetBank("leaves_canopy_lhs")
        new_widget_AnimState:SetBuild("leaves_canopy_lhs")
        ...
        --new_widget_AnimState:Show("flower01")
        --new_widget_AnimState:Show("flower02")
        --new_widget_AnimState:Show("flower03")
        --new_widget_AnimState:Show("flower04")
        --new_widget_AnimState:Show("flower05")
    end
end

local Leafcanopy_Lhs = Class(Widget, function(self, owner)
    self.owner = owner
    Widget._ctor(self, "Leafcanopy_Lhs")
...
function Leafcanopy_Lhs:OnUpdate(dt)
   ...
   -- print("刷新")
    ...
    if self.leavestop_intensity == 0 or (self.owner and not self.owner:HasTag("near_lhs")) then
        hideleaves(self)
    else
        showleaves(self)
